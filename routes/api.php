...
Route::prefix('server')->group(static function () {
    ...
    Route::prefix('share-url')->group(static function () {
...
Route::prefix('routing')->group(static function () {
...
Route::prefix('dns')->group(static function () {
...
Route::prefix('setting')->group(static function () {
